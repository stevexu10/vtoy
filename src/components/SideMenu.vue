<template>
  <div class="side-menu-wrapper">
    <slot></slot>
    <Menu ref="menu" v-show="true" :active-name="activeName" :open-names="openedNames" :accordion="accordion" :theme="theme" width="auto" @on-select="handleSelect">
      ...
      menuList: [
        {
          ...
          menuItems: [
            {
              id: 11,
              name: 'claim-record-breast-prostheses'
            },
            {
              id: 12,
              name: 'claim-record-communication-aid'
            },
            {
              id: 13,
              name: 'claim-record-insulin-syringe'
            }
          ]
        },
        {
