<template>
  <v-app id="inspire">
      <v-toolbar dark color="secondary" fixed>
        <v-toolbar-title class="white--text">Insulin syringe</v-toolbar-title>
        <v-spacer></v-spacer>
        ...
        <v-menu offset-y :nudge-left="170" :close-on-content-click="false">
          ...
          <v-layout v-resize="onResize" column style="padding-top:56px">
            <v-data-table :headers="headers" :items="claimFromGraphql" :search="search" :pagination.sync="pagination" :hide-headers="isMobile" :class="{mobile: isMobile}">
